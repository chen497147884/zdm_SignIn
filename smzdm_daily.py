...
SMZDM_USERNAME = os.getenv('SMZDM_DAILY_USERNAME') or '497147884@qq.com' # username or email
SMZDM_PASSWORD = os.getenv('SMZDM_DAILY_PASSWORD') or 'AI7758521chen' # password
